...
async function postSearch(jar, kw, vs, vsg, ev) {
...
function categorizeByFacts(gist) {
...
async function main() {
  ...
  const log = isQuiet ? () => {} : (...a) => console.log(...a)
  const chains = chainFilter ? [chainFilter] : Object.keys(KEYWORDS)
      ...
      try {
        ...
        for (let page = 1; page <= maxPages; page++) {
          ...
          try {
            ...
            log(`    ⚠ page ${page} fail: ${e.message.slice(0, 60)}`)
            break
          }
        ...
        for (const hit of pageHits) {
          ...
          const yearInt = parseInt(
            ((_a = hit.caseNo.match(/(\d+)/)) === null || _a === void 0 ? void 0 : _a[0]) || '0',
            10,
          )
          const precedent = {
...
if (
  ((_a = process.argv[1]) === null || _a === void 0 ? void 0 : _a.endsWith('scrape-cloud.ts')) ||
  ((_b = process.argv[1]) === null || _b === void 0 ? void 0 : _b.endsWith('scrape-cloud.js'))
) {
  main().catch((e) => {
